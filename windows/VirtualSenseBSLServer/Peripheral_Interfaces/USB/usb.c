...
//__no_init WORD wBytesRemainingOnIEP0;     // For endpoint zero transmitter only
...
//__no_init WORD wBytesRemainingOnOEP0;     // For endpoint zero transmitter only
...
VOID USB_init(VOID)
{
    ...
    //    USBMCNF    = USB_EN;            // enable USB module
...
VOID USB_enable()
{
    ...
    USBPLLDIVB = wUSBPLL;; //USBPLL_SETCLK_4_0;                 // Settings desired frequency
...
VOID USB_suspend(VOID)
{
    ...
    USBPLLCTL = UCLKSEL1;   // disable PLL, XT2CLK is selected as USB module clock
