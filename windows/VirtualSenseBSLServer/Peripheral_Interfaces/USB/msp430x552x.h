...
* MSP430x552x devices.
*
* Texas Instruments, Version 0.9 draft 5/22/2009
*
* Rev. 0.0, Setup
*
*
...
#define DMA1TSEL_7          (7*0x0001u)  /* DMA channel 1 transfer select 7:  TimerB (TB0CCR0.IFG) */
#define DMA1TSEL_8          (8*0x0001u)  /* DMA channel 1 transfer select 8:  TimerB (TB0CCR2.IFG) */
...
#define DMA1TSEL__TB0CCR0   (7*0x0001u)  /* DMA channel 1 transfer select 7:  TimerB (TB0CCR0.IFG) */
#define DMA1TSEL__TB0CCR2   (8*0x0001u)  /* DMA channel 1 transfer select 8:  TimerB (TB0CCR2.IFG) */
...
#define  PMAPPWD_            (0x01C0)  /* Port Mapping password register */
DEFCW(   PMAPPWD           , PMAPPWD_)
#define  PMAPCTL_            (0x01C2)  /* Port Mapping control register */
DEFCW(   PMAPCTL           , PMAPCTL_)

#define  PMAPPW              (0x2D52)  /* Port Mapping Password */
...
#define LOCKBAK             (0x0001)  /* Lock I/O pin configuration upon entry/exit to/from LPM5 */

/* PM5CTL0 Power Mode 5 Control Bits */
#define LOCKBAK_L           (0x0001)  /* Lock I/O pin configuration upon entry/exit to/from LPM5 */

/* PM5CTL0 Power Mode 5 Control Bits */
#define LOCKIO              LOCKBAK   /* Lock I/O pin configuration upon entry/exit to/from LPM5 */
...
#define SYSUNIV_SYSBUSIV   (0x0008)    /* SYSUNIV : Bus Error - SYSBERRIV */
...
/* ========================================================================= */
#define USBKEYPID_     (0x0900)    /* USB Controller peripheral ID and key register */
DEFCW(  USBKEYPID    , USBKEYPID_)
...
#define PSEIEN              (0x0100)  /* USB - PHY Single Ended Input enalbe */
#define PDEIEN              (0x0200)  /* USB - PHY Differential Ended Input enalbe */
//#define RESERVED            (0x0100)  /* USB -  */
//#define RESERVED            (0x0200)  /* USB -  */
//#define RESERVED            (0x0400)  /* USB -  */
//#define RESERVED            (0x0800)  /* USB -  */
...
/* USBPHYCTL Control Bits */
#define PSEIEN_H            (0x0001)  /* USB - PHY Single Ended Input enalbe */
#define PDEIEN_H            (0x0002)  /* USB - PHY Differential Ended Input enalbe */
//#define RESERVED            (0x0100)  /* USB -  */
//#define RESERVED            (0x0200)  /* USB -  */
//#define RESERVED            (0x0400)  /* USB -  */
//#define RESERVED            (0x0800)  /* USB -  */
...
DEFC(   USBCTL       , USBCTL_)
#define USBIE_         (0x093D)    /* USB interrupt enalbe register */
DEFC(   USBIE        , USBIE_)
...
//sfrb    USBTOPBUFF      (0x236F)    /* Top of buffer space */
